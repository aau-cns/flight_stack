...
REM_PI2="ssh core@${PI2_IP}"
CMD_PI2="/home/core/catkin_ws/src/amadee/scripts/record_scripts/record_full_setup.sh"
...
if [ "${REC_IN}" == "full" ] || [ "${REC_IN}" == "cam" ] || [ "${REC_IN}" == "cam" ] ; then
  ...
  "${REM_PI1} '${CMD_PI2} dev2_${REC_IN} ${PATH_LOCAL} ${PATH_MEDIA}'"
else
